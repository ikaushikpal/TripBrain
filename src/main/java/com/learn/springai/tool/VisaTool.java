...
public class VisaTool {
    ...
    public String getVisaInfo(
        ...
        try {
            ...
            String url = BASE_URL + "/visa/" + passportCode + "/" + destinationCode;

            VisaResponse response = client.get()
                    .uri(url)
                    .retrieve()
    ...
    public String getVisaStats(
        ...
        try {
            ...
            String url = BASE_URL + "/country/" + passportCode;

            CountryVisaStats response = client.get()
                    .uri(url)
                    .retrieve()
